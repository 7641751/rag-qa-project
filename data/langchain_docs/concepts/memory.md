<!-- source: https://docs.langchain.com/oss/python/concepts/memory.md | section: /oss/python/concepts | fetched: 2026-09-09 -->
...
Regardless of memory management approach, the central point is that the agent will use the semantic memories to [ground its responses](/oss/python/deepagents/retrieval), which often leads to more personalized and relevant interactions.
...
As an example, ChatGPT uses a [save\_memories](https://openai.com/index/memory-and-new-controls-for-chatgpt/) tool to upsert memories as content strings, deciding whether and how to use this tool with each user message. See our [memory-agent](https://github.com/langchain-ai/memory-agent) template as a reference implementation.
