<!-- source: https://docs.langchain.com/oss/python/langchain/multi-agent/custom-workflow.md | section: /oss/python/langchain | fetched: 2026-09-09 -->
...
- [Tutorial: Build a multi-source knowledge base with routing](/oss/python/langchain/multi-agent/router-knowledge-base)
