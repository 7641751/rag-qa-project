<!-- source: https://docs.langchain.com/oss/python/langchain/multi-agent/handoffs.md | section: /oss/python/langchain | fetched: 2026-09-09 -->
...
- [Tutorial: Build customer support with handoffs](/oss/python/langchain/multi-agent/handoffs-customer-support)
