<!-- source: https://docs.langchain.com/oss/python/langchain/multi-agent/skills.md | section: /oss/python/langchain | fetched: 2026-09-09 -->
...
- [Tutorial: Build a SQL assistant with on-demand skills](/oss/python/langchain/multi-agent/skills-sql-assistant)
