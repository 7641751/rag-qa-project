<!-- source: https://docs.langchain.com/oss/python/langchain/structured-output.md | section: /oss/python/langchain | fetched: 2026-09-09 -->
...
<ParamField path="handle_errors">
  ...
  * **`False`**: No retry, let exceptions propagate
  ...
  class CustomerComplaint(BaseModel):
      """A customer complaint about a product or services."""
      issue_type: Literal["product", "services", "shipping", "billing"] = Field(description="The type of issue")
