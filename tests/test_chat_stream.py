...
def test_ungrounded_answer_is_persisted_in_history(monkeypatch):
    ...
    hist = chat_service.get_chat_history("t-stream")
...
def test_grounded_answer_is_persisted_as_true(monkeypatch):
